...
from hrrp3 import hrrp3_Dataset
    ...
    if args.todo == 'train' or args.todo == 'valid':
        ...
        if args.pretrain:
            if args.pretrain_dir != '':
                ...
                pretr_tr_dataset = hrrp3_Dataset(pretr_tr_data[va_size:], pretr_tr_label[va_size:])
                pretr_va_dataset = hrrp3_Dataset(pretr_tr_data[:va_size], pretr_tr_label[:va_size])
