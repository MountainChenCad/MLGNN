...
def parser():
    ...
    parser.add_argument('--dataset', default='gaf12', help='the dataset to train')
    ...
    parser.add_argument('--max_iteration', default=5000, type=int, help='max iteration to train')
    parser.add_argument('--log_interval', default=50, type=int)
    parser.add_argument('--eval_interval', default=50, type=int)
    parser.add_argument('--early_stop', default=5000, type=int,
    ...
    parser.add_argument('--data_root', default='gaf12_100', help='root for train data')
    parser.add_argument('--log_root', default='gaf100_log', help='the root to save log')
    ...
    parser.add_argument('--l2_reg_lambda', type=float, default=0.02, help='Inner loop learning rate.')
